<template>
  <view class="bottom-nav">
    <view class="nav-item" :class="{ active: activePath === '/pages/index/index' }" @click="goToPage('/pages/index/index')">
...
const goToPage = (url) => {
  ...
  // Use reLaunch to handle main pages if they are meant to be tabs
  uni.reLaunch({
    url
  });
};
